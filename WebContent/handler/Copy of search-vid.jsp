...
<%
	...
	launchPresentation.put( BasicLTIConstants.PARAM_RESOURCE_LINK_TITLE, "Ensemble Video");
	launchPresentation.put( BasicLTIConstants.PARAM_TOOL_CONSUMMER_INFO_CODE, "bblearn");
	launchPresentation.put("xxx","testing");
